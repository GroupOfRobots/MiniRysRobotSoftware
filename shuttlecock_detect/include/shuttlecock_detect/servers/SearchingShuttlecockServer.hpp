...
class SearchingShuttlecockServer : public rclcpp::Node {
public:
  explicit SearchingShuttlecockServer(
...
private:
  ...
  rclcpp::Subscription<btcpp_ros2_interfaces::msg::DistancesAndTransform>::
      SharedPtr subscription_dat_;
