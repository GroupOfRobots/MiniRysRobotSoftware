...
int main(int argc, char **argv) {
  ...
  factory.registerNodeType<DeliverShuttlecockAction>("DeliverShuttlecockAction",
                                                     paramsDn);
  ...
  factory.registerNodeType<GetToShuttlecockAction>("GetToShuttlecockAction",
                                                   paramsGn);
  ...
  factory.registerNodeType<PickShuttlecockAction>("PickShuttlecockAction",
                                                  paramsPn);
  // RotateAction
  ...
  factory.registerNodeType<SearchingShuttlecockAction>(
      "SearchingShuttlecockAction", paramsSn);

  string package_share_directory =
      ament_index_cpp::get_package_share_directory("shuttlecock_detect");
  auto tree = factory.createTreeFromFile(
      package_share_directory + "/behavior_trees/detect_shuttlecock.xml");
