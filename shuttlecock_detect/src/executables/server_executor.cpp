...
int main(int argc, char **argv) {
  ...
  auto deliverShuttlecockServer =
      std::make_shared<DeliverShuttlecockServer>(options);
  auto getToShuttlecockServer =
      std::make_shared<GetToShuttlecockServer>(options);
  ...
  auto searchingShuttlecockServer =
      std::make_shared<SearchingShuttlecockServer>(options);
