...
int main() {
	...
	sensor1.setDistanceMode(VL53L1X::DISTANCE_MODE_LONG);
	sensor1.setTimingBudget(VL53L1X::TIMING_BUDGET_100_MS);
	sensor1.setInterMeasurementPeriod(100);
	sensor2.setDistanceMode(VL53L1X::DISTANCE_MODE_LONG);
	sensor2.setTimingBudget(VL53L1X::TIMING_BUDGET_100_MS);
	sensor2.setInterMeasurementPeriod(100);
	sensor3.setDistanceMode(VL53L1X::DISTANCE_MODE_LONG);
	sensor3.setTimingBudget(VL53L1X::TIMING_BUDGET_100_MS);
	sensor3.setInterMeasurementPeriod(100);
